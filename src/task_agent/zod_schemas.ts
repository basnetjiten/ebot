...
export const TodoDataSchema = z
    .object({
        ...
        reminderTime: z
            .string()
            .describe('ISO 8601 date string for when to send a reminder')
            .optional(),
...
export const HabitDataSchema = z
    .object({
        frequency: z
            .string()
            .describe('Frequency of the habit, e.g., "daily", "weekly", "Mon,Wed,Fri"'),
        timeOfDay: z
            .string()
            .describe('Preferred time of day for the habit, e.g., "07:00"')
            .optional(),
...
export const TaskExtractionSchema = z
    .object({
        type: z
            .enum(['todo', 'event', 'habit', 'reminder'])
            .describe('The type of task being created or updated'),
        title: z.string().describe('The title of the task'),
        summary: z
            .string()
            .describe(
                'A friendly, user-facing summary of the task plan (using local time for display)',
            )
            .optional(),
        ...
        data: z
            ...
            .describe('The specific details of the task (e.g. startTime, priority, etc.)')
            .optional(),

        isUpdate: z
            .boolean()
            .describe('Set to true if this request is modifying an existing task context')
            .optional(),
        conversationalResponse: z
            .string()
            .describe(
                'A warm, friendly response in valid JSON (no markdown) acknowledging the user request',
            )
            .optional(),
        ...
        missingFields: z
            ...
            .describe('List of fields that are required but missing from the user request')
            .optional(),

        validationErrors: z
            .array(z.string())
            .describe('List of any logic validation errors')
            .optional(),
    })
